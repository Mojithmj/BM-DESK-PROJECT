    ...
    <div>
      ...
      <div className="flex flex-col gap-3 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[20px]">
          ...
          <div key={index} className="flex flex-col justify-between border-[1px]  2xl:p-[36px] lg:p-[10px] md:p-[5px]  rounded-2xl text-[#E5E6EB]  bg-[#FFF] ">
            <div className="flex flex-row items-center justify-between">
            ...
            <div
              className="2xl:p-[19px] lg:p-[10px]"
