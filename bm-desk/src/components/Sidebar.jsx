  ...
  const menuItems = [
    ...
    // Tickets section with dynamic dropdown
    {
      ...
      icon: (
        ...
        >
          <path
            d="M16.2501 10.9173C16.2501 9.76732 17.1834 8.83398 18.3334 8.83398V8.00065C18.3334 4.66732 17.5001 3.83398 14.1667 3.83398H5.83341C2.50008 3.83398 1.66675 4.66732 1.66675 8.00065V8.41732C2.81675 8.41732 3.75008 9.35065 3.75008 10.5007C3.75008 11.6507 2.81675 12.584 1.66675 12.584V13.0007C1.66675 16.334 2.50008 17.1673 5.83341 17.1673H14.1667C17.5001 17.1673 18.3334 16.334 18.3334 13.0007C17.1834 13.0007 16.2501 12.0673 16.2501 10.9173Z"
            stroke="currentColor"
            stroke-width="1.5"
          ...
          />
          <path
            d="M8.33325 3.83398L8.33325 17.1673"
            stroke="currentColor"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
...
//   // Menu items array remains the same as your original code
//   const menuItems = [
//     {
//       label: "Dashboards",
//       icon: <RiHomeLine />,
...
//       {!isCollapsed && item.dropdown && openDropdown === item.label && (
//         <div className="pl-4">
//           {item.dropdown.map((subItem, subIndex) => (
//             <div
//               key={subIndex}
...
//             </button>
//           </SheetTrigger>
//           <SheetContent side="left" className="w-[280px] p-4 bg-white h-full">
...
//                 {menuItems.map((item, index) => (
//                   <MenuItem key={index} item={item} isCollapsed={false} />
//                 ))}
//               </div>
//             </div>
//           </SheetContent>
...
//             {menuItems.map((item, index) => (
//               <MenuItem key={index} item={item} isCollapsed={!isSidebarOpen} />
//             ))}
//           </div>
//         </div>
//       </aside>
